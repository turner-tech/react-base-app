...
export const StarMatch = (props: any) => {
    ...
    return (
        <div className="star-match">
            <Card title="StarMatch - Pick 1 or more numbers that sum to the number of stars" style={{width: 900}}>
                ...
                <div className="body">
                    ...
                    <div className="right">
                        {utils.range(1, 9).map((numId) => (
                            <PlayNumber key={numId} numStatus={numStatus(numId)} numId={numId} onClick={onNumClick}/>
                        ))}
                    </div>
                </div>
